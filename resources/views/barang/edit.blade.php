...
@section('subtitle', 'Perbarui data barang yang sudah ada')
    ...
    <div class="col-lg-9 col-xl-8">
        <div class="sigap-card" style="padding: 1.75rem;">
            <div class="form-card-head">
                <div class="form-icon-pill"><i class="bi bi-pencil-square"></i></div>
                <div>
                    <h5>Edit Barang</h5>
                    <div class="sub">Mengubah data: <strong>{{ $barang->nama_barang }}</strong></div>
                </div>
            </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="jenis" class="sg-input"
                               value="{{ old('jenis', $barang->jenis) }}" required>
                    </div>
                    <div class="col-md-2">
                        <label class="sg-label">Stok <span class="req">*</span></label>
                        <input type="number" name="stok" class="sg-input"
                               min="0" value="{{ old('stok', $barang->stok) }}" required>
                    </div>
                    <div class="col-12">
                        <label class="sg-label">Deskripsi</label>
                        <textarea name="deskripsi" rows="3" class="sg-textarea">{{ old('deskripsi', $barang->deskripsi) }}</textarea>
                    </div>

                    @if($barang->gambar)
                        <div class="col-md-6">
                            <label class="sg-label">Gambar Saat Ini</label>
                            <div class="current-img-wrap">
                                <img src="{{ asset('uploads/barang/'.$barang->gambar) }}" class="current-img" alt="">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="sg-label">Ganti Gambar</label>
